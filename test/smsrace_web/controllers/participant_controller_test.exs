defmodule SmsraceWeb.ParticipantControllerTest do
  use SmsraceWeb.ConnCase

  alias Smsrace.SMSRace

  @create_attrs %{name: "some name", nr: 42, phonenumber: "some phonenumber"}
  ...
  def fixture(:participant) do
    {:ok, participant} = SMSRace.create_participant(@create_attrs)
    participant
  end
